...
class MainActivity : AppCompatActivity() {
    ...
    //función que calcula el resultado final de la operación
    ...
    //función que sirve para quitar los ceros de la izquierda
    ...
    //función que sirve para realizar las operaciones
    //y también para detectar cuando existe un error de sintaxis
        ...
        return object : Any() {
            ...
            fun parseFactor(): Double {
                ...
                if (eat('('.toInt())) { // parentheses
                    ...
                    throw RuntimeException("Error de sintaxis: ")
                }
